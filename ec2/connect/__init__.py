...
from common_utils.aws import get_ec2_address_by_name, get_ec2_address_by_id
...
def connect_to_ec2_instance(args: Namespace):
    ...
    :return: None
    """
    instance_address = _get_instance_id_from_identifier(args.identifier)
    if instance_address:
...
def _get_instance_id_from_identifier(idtfr: str) -> str:
